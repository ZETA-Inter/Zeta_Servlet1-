...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Assinatura/criarAssinatura.css">
...
<main>
    <div class="inserirADM">
        <h1>Assinatura inserida com sucesso</h1>
    </div>
    <div class="sidebar">
        <div class="icon active">
            <a href="${pageContext.request.contextPath}/Adm/menuAdm.html">
    ...
    <div class="campos">
        <a href="${pageContext.request.contextPath}/Assinatura/criarAssinatura.html"><button type="submit">Inserir outro</button></a>
    </div>
</main>
</body>
</html>
