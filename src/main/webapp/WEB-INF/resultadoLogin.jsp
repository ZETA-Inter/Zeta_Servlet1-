...
<main class="main">
    <section class="login">
        <div class="admContent">
            ...
            <form class="loginAdmin" action="loginADM" method="post">
                <div id="emailLogin">
            ...
            <div id="ErroLogin" class="ErroLogin">
                <label>
                ...
                %>
                <h3 style="color: green">Login realizado com sucesso, Redirecionando...</h3>
                <%
                        request.getRequestDispatcher("/menuAdm.html").forward(request, response);
                    }
                    else if (option==0){
                %>
                <h3 style="color: red">As informações estão incorretas, tente novamente</h3>
                <%
                    }else{
                %>
                <h3 style="color: red">As informações eeafkjwiugbwaislugbvstão incorretas, tente novamente</h3>
                <%
                    }%>
            </div>
